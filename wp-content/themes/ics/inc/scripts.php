...
function roots_scripts() {
  ...
  if (is_single() && comments_open() && get_option('thread_comments')) {
    ...
    wp_register_script('greensock', 'http://cdnjs.cloudflare.com/ajax/libs/gsap/1.13.2/TweenMax.min.js', array('jquery'), false, true );
    wp_register_script('greensock-css', 'http://cdnjs.cloudflare.com/ajax/libs/gsap/latest/plugins/CSSPlugin.min.js', array('jquery', 'greensock'), false, true );
    wp_register_script('features_home', get_template_directory_uri() . '/js/features.js', array('jquery', 'greensock', 'greensock-css'), null, false);
