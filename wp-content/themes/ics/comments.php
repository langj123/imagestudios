...
<?php if (comments_open()) { ?>
  <section id="respond">
		<hr>
    <h3><?php comment_form_title(__('What do you think?', 'roots'), __('Leave a Reply to %s', 'roots')); ?></h3>
    ...
    <?php } else { ?>
      <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
        ...
        <p><input name="submit" class="yellow-button" type="submit" id="submit" tabindex="5" value="<?php _e('Submit', 'roots'); ?>"></p>
